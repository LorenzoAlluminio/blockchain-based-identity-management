...
The function that need to be implemented are: addiction, subtraction,query and verifyPayment,new account
...
methods: publishOffer,acceptOffer,query,removeOffer
