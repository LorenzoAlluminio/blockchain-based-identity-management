...
The goal of this project is to create an autonomous market of access to services by creating an hyperledger network between multiple service providers of different kind (e.g video  & music streaming, e-learning, vpn access, hosting … ).
